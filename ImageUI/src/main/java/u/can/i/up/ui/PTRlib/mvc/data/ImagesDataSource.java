 ...
 */
package u.can.i.up.ui.PTRlib.mvc.data;

import java.util.ArrayList;
import java.util.List;

import u.can.i.up.ui.PTRlib.mvc.IDataSource;
import u.can.i.up.ui.PTRlib.utils.HttpUtils;


public class ImagesDataSource implements IDataSource<List<Book>> {
	private int page = 1;
