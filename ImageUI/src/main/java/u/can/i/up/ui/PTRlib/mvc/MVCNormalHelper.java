...
public class MVCNormalHelper<DATA> extends MVCHelper<DATA> {
	...
	public MVCNormalHelper(View contentView, ILoadViewFactory.ILoadView loadView) {
		super(new RefreshView(contentView), loadView);
	}

	public MVCNormalHelper(View contentView, ILoadViewFactory.ILoadView loadView, ILoadViewFactory.ILoadMoreView loadMoreView) {
