...
public class WithTextViewInFrameLayoutFragment extends TitleBaseFragment {
    public static WithTextViewInFrameLayoutFragment newInstance(Bundle bundle)
    {
        WithTextViewInFrameLayoutFragment withTextViewInFrameLayoutFragment = new WithTextViewInFrameLayoutFragment();

        if (bundle != null)
        {
            withTextViewInFrameLayoutFragment.setArguments(bundle);
        }

        return withTextViewInFrameLayoutFragment;
    }
    @Override
