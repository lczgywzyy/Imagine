 ...
 */
public class HttpAlbumUploadManager extends IHttpManager<IHttpNormalBean> {

    private static HttpAlbumUploadManager httpNormalManager;

    private Handler handler;

    private HttpAlbumUploadManager(){
    ...
    public synchronized static HttpAlbumUploadManager getHttpNormalManagerInstance(){
        if(httpNormalManager ==null){
            httpNormalManager =new HttpAlbumUploadManager();
        }
